...
from eval_hete import label_classification_hete
...
if __name__ == '__main__':
    ...
    log_file = osp.join(log_dir, f"run_hete_results.txt")
    ...
    for epoch in range(1, num_epochs + 1):
        # Determine root node sample size based on dataset
    ...
    micro_f1_mean, micro_f1_std, macro_f1_mean, macro_f1_std, acc_mean, acc_std = \
        label_classification_hete(emb, data.y, data)
